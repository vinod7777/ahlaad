...
export default function CheckIn() {
  ...
  const participantsPagination = usePagination(filteredParticipants, 10);
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs border-collapse">
                  ...
                  <tbody className="divide-y divide-white/5">
                    {participantsPagination.paginatedItems.map(p => (
                      <tr key={p.pass_id} className="hover:bg-white/[0.02] transition-colors group">
                        <td className="py-4 px-6">
                          ...
                          <p className="text-[10px] text-white/40 mt-0.5"> {p.college}</p>
                          {p.team_name && (
                ...
                <PaginationControls
                  ...
                  itemsPerPage={participantsPagination.itemsPerPage}
                  onNextPage={participantsPagination.nextPage}
                  onPrevPage={participantsPagination.prevPage}
                  onGoToPage={participantsPagination.goToPage}
                />
              </div>
            )}
